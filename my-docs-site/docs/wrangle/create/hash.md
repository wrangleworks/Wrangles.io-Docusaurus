...
| output | Output | list | No | Name of new column |  | ["Hash Output"] |
| method | Method | select | No | The method to use to hash the input (Default: md5) | md5, sha1, sha256, sha512 | "" |
